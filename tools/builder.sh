...
# no: rtl-sdr, kmod-usb-net-*, kmod-usb-serial-*, kmod-rtl8192cu, kmod-usb-acm, kmod-usb-wdm, kmod-lib-crc-itu-t, kmod-fs-nfs, kmod-fs-vfat, ppp*, python-*, chat, libgdbm, mtd, nano, netcat, ssmtp, usb-modeswitch, usbreset
PACKAGES_UNIVERSAL="iw at autossh base-files bash block-mount ca-certificates dnsmasq e2fsprogs ethtool firewall hostapd-utils ip6tables iwinfo kmod-crypto-manager kmod-fs-ext4 kmod-gpio-button-hotplug kmod-ipt-offload kmod-leds-gpio kmod-ledtrig-default-on kmod-ledtrig-netdev kmod-ledtrig-timer kmod-mt76x2u kmod-nf-nathelper kmod-rt2800-usb kmod-rtl8187 kmod-scsi-generic kmod-usb-ohci kmod-usb-storage-extras kmod-usb-uhci kmod-usb2 libbz2-1.0 libcurl4 libelf1 libffi libgmp10 libiconv-full2 libltdl7 libnet-1.2.x libnl200 libustream-mbedtls20150806 libxml2 logd macchanger ncat nginx openssh-client openssh-server openssh-sftp-server openssl-util php7-fpm php7-mod-hash php7-mod-json php7-mod-mbstring php7-mod-session php7-mod-sqlite3 procps-ng-pkill procps-ng-ps tcpdump-mini uci uclibcxx uclient-fetch urandom-seed urngd usbutils wget wireless-tools wpad busybox libatomic1 libstdcpp6 -wpad-basic -dropbear -odhcpd-ipv6only -ppp -ppp-mod-pppoe"
